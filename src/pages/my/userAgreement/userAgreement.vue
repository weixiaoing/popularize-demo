<template>
  <view class="container">
    ...
    <br />
    <h1>隐私政策</h1>
    <div>更新日期：<strong>2024/3/11</strong></div>
    <div>生效日期：<strong>2024/3/11</strong></div>
    <h2>导言</h2>
    <p>
      <i>小推达人平台</i> 是一款由 <i>开发者</i> （以下简称“我们”）提供的产品。
    ...
    <p>如对本《隐私政策》或相关事宜有任何问题，请通过 <strong>179541527841</strong> 与我们联系。</p>
